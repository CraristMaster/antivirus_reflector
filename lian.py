...
#_____________Malware hashes_______________
...
class AntivirusApp(tk.Tk):
    ...
    def _build_body(self):
        ...
        btn_specs = [
            ...
            ("🛠 Maintenance And Repairment", self.show_maintenance_tab),
    ...
    # ---------------- Tab: Maintenance And Repairment----------------
    def _create_maintenance_tab(self):
        f = tk.Frame(self.content, bg=self.current_theme["bg"])
        self.tabs["maintenance And Repairment"] = f

        tk.Label(f, text="Maintenance & Repairment", bg=self.current_theme["bg"],
                 fg=self.current_theme["fg"], font=("Segoe UI", 16, "bold")).pack(pady=14)
    ...
    def show_maintenance_tab(self):
        self._show_tab("maintenance And Repairment")
...
if __name__ == "__main__":
    ...
    app.withdraw()
    app.after(9000, lambda: (splash.destroy(), app.deiconify()))
